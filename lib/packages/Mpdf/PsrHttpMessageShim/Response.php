...
namespace Dinamiko\DKPDFG\Vendor\Mpdf\PsrHttpMessageShim;

use Dinamiko\DKPDFG\Vendor\Psr\Http\Message\StreamInterface;
use Dinamiko\DKPDFG\Vendor\Psr\Http\Message\ResponseInterface;
use Dinamiko\DKPDFG\Vendor\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \Dinamiko\DKPDFG\Vendor\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \Dinamiko\DKPDFG\Vendor\Psr\Http\Message\StreamInterface */
	private $stream;
