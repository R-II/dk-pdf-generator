...
use Dinamiko\DKPDFG\Vendor\Mpdf\Color\ColorSpaceRestrictor;
use Dinamiko\DKPDFG\Vendor\Mpdf\File\LocalContentLoader;
use Dinamiko\DKPDFG\Vendor\Mpdf\Fonts\FontCache;
use Dinamiko\DKPDFG\Vendor\Mpdf\Fonts\FontFileFinder;
use Dinamiko\DKPDFG\Vendor\Mpdf\Http\CurlHttpClient;
use Dinamiko\DKPDFG\Vendor\Mpdf\Http\SocketHttpClient;
...
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\BackgroundWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\ColorWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\BookmarkWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\FontWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\FormWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\ImageWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\JavaScriptWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\MetadataWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\OptionalContentWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\PageWriter;
use Dinamiko\DKPDFG\Vendor\Mpdf\Writer\ResourceWriter;
...
class ServiceFactory
{
	...
	/**
	 * @var \Dinamiko\DKPDFG\Vendor\Mpdf\Container\ContainerInterface|null
	 */
	private $container;
