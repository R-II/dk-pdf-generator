...
class Tag
{
	...
	/**
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Mpdf $mpdf
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Cache $cache
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\CssManager $cssManager
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Form $form
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Otl $otl
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\TableOfContents $tableOfContents
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\SizeConverter $sizeConverter
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Color\ColorConverter $colorConverter
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \Dinamiko\DKPDFG\Vendor\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \Dinamiko\DKPDFG\Vendor\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'Dinamiko\DKPDFG\Vendor\Mpdf\Tag\\';
